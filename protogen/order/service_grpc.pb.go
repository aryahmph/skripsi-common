...
const (
	OrderService_GetProduct_FullMethodName = "/order.OrderService/GetProduct"
)
...
type OrderServiceClient interface {
	GetProduct(ctx context.Context, in *GetOrderRequest, opts ...grpc.CallOption) (*GetOrderResponse, error)
}
...
func (c *orderServiceClient) GetProduct(ctx context.Context, in *GetOrderRequest, opts ...grpc.CallOption) (*GetOrderResponse, error) {
...
type OrderServiceServer interface {
	GetProduct(context.Context, *GetOrderRequest) (*GetOrderResponse, error)
...
func (UnimplementedOrderServiceServer) GetProduct(context.Context, *GetOrderRequest) (*GetOrderResponse, error) {
