...
type PaymentServiceClient interface {
	GetPaymentByOrderID(ctx context.Context, in *GetPaymentByOrderIDRequest, opts ...grpc.CallOption) (*GetPaymentResponse, error)
}
...
func (c *paymentServiceClient) GetPaymentByOrderID(ctx context.Context, in *GetPaymentByOrderIDRequest, opts ...grpc.CallOption) (*GetPaymentResponse, error) {
...
type PaymentServiceServer interface {
	GetPaymentByOrderID(context.Context, *GetPaymentByOrderIDRequest) (*GetPaymentResponse, error)
...
func (UnimplementedPaymentServiceServer) GetPaymentByOrderID(context.Context, *GetPaymentByOrderIDRequest) (*GetPaymentResponse, error) {
